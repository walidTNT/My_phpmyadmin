...
<html>
    ...
    <body>
		...
		<div class="choosebdd">
			<label class="labelFormSql" for="liste">Sur :</label>
			   <select name="bdd" id="bdd" >
				   <option value="localhost">serveur localhost</option>
				   <option value="bdd2">Base de données</option>
			   </select>			   
		</div>
		<div class="zonesql">				
			<form action="#" method="post">
				<textarea name="message" rows="10" cols="100">Ecrivez votre requête SQL ici...
				</textarea>
				<p><input type="submit" value="Exécuter" /></p>
			</form>
		</div>
